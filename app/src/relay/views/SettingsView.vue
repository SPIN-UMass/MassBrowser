...
<script>
  ...
  export default {
    ...
    data () {
      return {
        bandwidthLimited: relayManager.bandwidthLimited,
        uploadLimit: relayManager.uploadLimit / 8000,
        downloadLimit: relayManager.downloadLimit / 8000,
        natDisable: !relayManager.natEnabled,
        portNumber: relayManager.OBFSPortNumber
      }
    },
    computed: {
     bandwidthLimited: {
